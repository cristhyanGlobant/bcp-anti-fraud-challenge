...
public class TransactionServiceTests
{
    ...
    public async Task CreateTransactionAsync_SavesTransaction_And_ProducesKafkaEvent()
    {
        ...
        _mockRepository.Setup(r => r.SaveAsync(It.IsAny<Transaction>()))
        ...
        // Assert
        _mockRepository.Verify(r => r.SaveAsync(It.Is<Transaction>(t =>
        ...
        _mockKafkaProducer.Verify(k => k.ProduceAsync("transaction-created", It.IsAny<object>()), Times.Once);
